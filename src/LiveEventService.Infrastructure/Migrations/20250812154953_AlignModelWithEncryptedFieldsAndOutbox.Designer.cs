...
namespace LiveEventService.Infrastructure.Migrations
{
    ...
    [Migration("20250812154953_AlignModelWithEncryptedFieldsAndOutbox")]
    partial class AlignModelWithEncryptedFieldsAndOutbox
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LiveEventService.Core.Events.Event", b =>
                {
                    ...
                    b.HasIndex("OrganizerId", "StartDate");
            ...
            modelBuilder.Entity("LiveEventService.Core.Registrations.EventRegistration.EventRegistration", b =>
                {
                    ...
                    b.HasIndex("EventId", "Status", "RegistrationDate");
            ...
            modelBuilder.Entity("LiveEventService.Infrastructure.Data.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
